...
#pragma pack(pop)
	...
	public:
		virtual void initialize() volatile;

	public:
		void handle_vmexit(intel::VmExitReason reason, VcpuContext* vcpu_context, VmExitGuestState* guest_state, bool& increment_rip) const volatile;
